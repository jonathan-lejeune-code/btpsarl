  ...
  <v-container class="service bg-light section text-xs-center">
    ...
    <v-layout wrap justify-center>
      <v-flex xs12 sm4 px-3>
        <div class="service-item">
          <div class="service-ico">
            <v-icon large color="orange">mdi-hammer-screwdriver</v-icon>
          </div>

          <h4 class="service-title">matériel</h4>
      ...
      <v-flex xs12 sm4 px-3>
        <div class="service-item">
          <div class="service-ico">
            <v-icon large color="orange">mdi-wrench</v-icon>
          </div>

          <h4 class="service-title">réparation</h4>

          <div class="service-body">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ullam,
            consequuntur laboriosam sequi magni deleniti possimus earum libero
            veritatis odio numquam.
          </div>
        </div>
      </v-flex>
      <v-flex xs12 sm4 px-3>
        <div class="service-item">
          <div class="service-ico">
            <v-icon large color="orange">mdi-forklift</v-icon>
          </div>

          <h4 class="service-title">angin</h4>

          <div class="service-body">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam,
            architecto voluptas deleniti quisquam iusto odio temporibus autem.
          </div>
        </div>
      </v-flex>
    </v-layout>
